...
The rates at which males encounter females \(R_{\mathrm{f},\mathrm{m}}\)
and females encounter males with nuptial gifts
\(R_{\mathrm{m_{G}}, \mathrm{f}}\) are calculated directly from the IBM,
thereby modelling how these rates might be estimated from empirical
data, so the male threshold for increasing fitness by searching is,
