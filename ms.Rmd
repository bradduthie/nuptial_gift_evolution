...
In a sensitivity analysis, we also re-ran simulations for values of $T_{\mathrm{f}} = 10$ and $\psi = \{1, 2, 4, 6 \}$ (see Supporting Information S3), and simulated the evolution of male nuptial gift searching and female choosiness (fixing $T_{\mathrm{m}} = \alpha$) separately (see Supporting Information S4).
